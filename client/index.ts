...
export class ChromeBridge {
  ...
  async copyToClipboard(opts: { imagePath?: string; html?: string }) {
    return this.command("os.clipboard.write", opts)
  }

  async paste(opts?: { retries?: number; delay?: number; app?: string }) {
    return this.command("os.paste", opts)
  }
}
