...
const xPostParams = z.object({
  text: z.string().describe("The tweet text to post"),
  images: z.array(z.string()).optional().describe("Array of image file paths to attach"),
})
  ...
  commands: {
    post: {
      ...
      async execute(params: unknown, ctx: ExecutionContext) {
        const p = params as z.infer<typeof xPostParams>
