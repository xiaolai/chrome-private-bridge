...
// Use the same CONFIG_DIR that the store module resolved at import time
const testDir = config.configDir

describe("store module", () => {
  beforeEach(() => {
    // Clean the keys file before each test
  ...
  test("loadKeys returns empty store when file contains invalid JSON", () => {
    saveKeys({ keys: [] }) // ensure dir exists
